  ...
  const inner = (
    <>
      ...
      <form
        ...
        {...props}
      >
        <InputGroup className="overflow-hidden bg-background dark:bg-neutral-900">
          {children}
        </InputGroup>
      </form>
    </>
...
interface SpeechRecognition extends EventTarget {
  ...
  onresult: // biome-ignore lint/suspicious/noExplicitAny: <explanation>
  ((this: SpeechRecognition, ev: SpeechRecognitionEvent) => any) | null;
  onerror: // biome-ignore lint/suspicious/noExplicitAny: <explanation>
